...
public class SJF_P {
    ...
    static void beklemeZamaniBul(Process prosesler[], int prosesSayisi,int beklemeZamani[]) //proses matrisi, proses sayisi, beklemeZamani proses sayisi boyutunda dizi 
    {
        ...
        while (tamamMi != prosesSayisi) {
            ...
            {
                if ((prosesler[j].varisZ <= tempValue) &&
                  (patlamaZamanlari[j] < ekd) && patlamaZamanlari[j] > 0) {
            ...
            if (patlamaZamanlari[enKisa] == 0) {
                ...
                beklemeZamani[enKisa] = bitisZamani -
                             prosesler[enKisa].patlamaZ - prosesler[enKisa].varisZ;
    ...
    static void ortalamaZamaniBul(Process prosesler[], int prosesSayisi)
    {
        ...
        System.out.println("Varýþ Zamaný "+"Patlama Zamaný " + " Bekleme Zamaný " + " Donus Zamani" + " Tamamlanma Zamani");
